...
func (m *migrator) Generate() error {
	...
	doNotEditSignFilename := filepath.Join(m.conf.getExportDir(), _doNotEditName)
	_ = os.Truncate(doNotEditSignFilename, 0)
	if err := os.WriteFile(doNotEditSignFilename, nil, 0644); err != nil {
...
const (
	...
	_doNotEditName = "DO_NOT_EDIT_THIS_FOLDER!!!"
)
...
const (
	...
	_textGeneratedBy = "-- Generate by github.com/yanun0323/gem"
)
